...
def connect_database():
    if emailEntry.get()==''or usernameEntry.get()==''or passwordEntry.get()==''or confirmEntry.get()=='':
        ...
        try:
            con= pymysql.connect(host='localhost',user='root',passwd='1928')
            mycursor=con.cursor()
        except:
...
alreadyaccount=Label(frame, text="Do have an account?", font=('Open Sans', '9', 'bold'), bg='white', fg= 'firebrick1') 
